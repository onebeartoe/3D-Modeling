...
scale([1,1,2.5])translate([0,0,-0.51])heartThumbnail();translate([-11.7,6,-1.21])scale([0.1,0.1,2.5])heartThumbnail();translate([11.7,6,-1.21])scale([0.1,0.1,2.5])heartThumbnail();translate([12,1,-1.21])scale([0.1,0.1,2.5])heartThumbnail();translate([-12,1,-1.21])scale([0.1,0.1,2.5])heartThumbnail();translate([-9,-3,-1.21])scale([0.1,0.1,2.5])heartThumbnail();translate([9,-3,-1.21])scale([0.1,0.1,2.5])heartThumbnail();translate([5,-7,-1.21])scale([0.1,0.1,2.5])heartThumbnail();translate([-5,-7,-1.21])scale([0.1,0.1,2.5])heartThumbnail();translate([0,-11,-1.21])scale([0.1,0.1,2.5])heartThumbnail();}